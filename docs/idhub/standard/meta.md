...
| classifyName                                   | String  | 本企业内的分类名称                                                    | ”食品"                                   |
| metaHandle                                     | String  | 元数据标识                                                            | "88.608.6688/META_xz_test2"               |
| metaName                                       | String  | 元数据名称                                                            |                                           |
| metaCode                                       | String  | 元数据代码                                                            |                                           |
| industry                                       | String  | 行业分类描述                                                          | "农、林、牧、渔业/农业/谷物种植/稻谷种植" |
| industryCategory                               | String  | 行业分类一级                                                          | "A"                                       |
| industrySpecific                               | String  | 行业分类二级                                                          |                                           |
| industryTrade                                  | String  | 行业分类三级                                                          |                                           |
| industrySubclass                               | String  | 行业分类四级                                                          |                                           |
| metaState                                      | Integer | 发布状态，`0-未发布  1-已发布`                                      |                                           |
| metaContributor                                | String  | 贡献者                                                                | "88.608.8889"                             |
| standard                                       | String  | 依据标准                                                              |                                           |
| metaDesc                                       | String  | 元数据描述                                                            |                                           |
| createdTime                                    | String  | 创建时间                                                              | "2024-05-21 16:59:02"                     |
| updatedTime                                    | String  | 更新时间                                                              | "2024-05-21 16:59:02"                     |
| itemVOS[i].itemCode                            | String  | 实体编码                                                              |                                           |
| itemVOS[i].itemIndex                           | Integer |                                                                       | 2000                                      |
| itemVOS[i].itemState                           | Integer | 实体状态，枚举：0-启用 1-禁用                                         |                                           |
| itemVOS[i].englishName                         | String  | 实体英文名称                                                          |                                           |
| itemVOS[i].chineseName                         | String  | 实体中文名称                                                          |                                           |
| itemVOS[i].definition                          | String  | 实体定义                                                              |                                           |
...
| itemVOS[i].itemSchemaVO.dataType               | Integer | 实体类型，`1：字符型，2：数值型，3：日期型，4：文件型，5：引用类型` |                                           |
| itemVOS[i].itemSchemaVO.minLength              | Integer | 最小长度                                                              |                                           |
| itemVOS[i].itemSchemaVO.maxLength              | Integer | 最大长度                                                              |                                           |
| itemVOS[i].itemSchemaVO.charRange              | String  | 字符值域                                                              |                                           |
| itemVOS[i].itemSchemaVO.accuracy               | Integer | 数值型精度                                                            |                                           |
| itemVOS[i].itemSchemaVO.numberRange            | String  | 数值范围                                                              |                                           |
| itemVOS[i].itemSchemaVO.dateFormat             | String  | 日期格式                                                              |                                           |
| itemVOS[i].itemSchemaVO.maxFileCount           | Integer | 最大文件数量                                                          |                                           |
| itemVOS[i].itemSchemaVO.fileRange              | Integer | 文件值域：`1：any，2：assign   `                                    |                                           |
| itemVOS[i].itemSchemaVO.fileType               | String  | 文件类型                                                              |                                           |
| itemVOS[i].itemSchemaVO.selfDefFileSuffix      | String  | 自定义文件后缀                                                        | "pem"                                     |
| itemVOS[i].itemSchemaVO.referenceType          | Integer | 引用类型：`1：一对一，2：一对多  `                                  |                                           |
| itemVOS[i].itemReferenceVO.referenceMetaHandle | String  | 引用元数据，dataType:5时必填                                          |                                           |
...
| 参数          | 类型   | 是否必填 | 最大长度 | 备注                                | 示例值                                             |
| ------------- | ------ | -------- | -------- | ----------------------------------- | -------------------------------------------------- |
| Authorization | String | 是       | -        | Bearer + 空格 + token(身份接口获取) | eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ.......... |
| Content-Type  | String | 是       | -        | application/json                    | application/json                                   |
...
| 参数           | 类型               | 是否必填 | 最大长度 | 备注               | 示例值                                                                     |
| -------------- | ------------------ | -------- | -------- | ------------------ | -------------------------------------------------------------------------- |
| metaHandleList | Array `<String>` | 是       | -        | 本企业内的分类code | [\"88.608.8889/META_xz_20240516\", \"88.608.8889/META_xz_test_schemaDTO\"] |

### 请求示例

```json
api/v1/open/meta/delete?metaHandleList=88.608.8889/META_3242&metaHandleList=88.608.8889/META_xz_copy_test
```
...
| metaItemInfo[i].itemCode                          | String  | 是       | 50       |                                                                       |        |
| metaItemInfo[i].englishName                       | String  | 是       | 50       |                                                                       |        |
...
| 参数                  | 类型   | 是否必填 | 最大长度 | 备注               | 示例值                          |
| --------------------- | ------ | -------- | -------- | ------------------ | ------------------------------- |
| baseonHandle          | String | 是       | -        | 要参照的元数据标识 | "88.608.6688/META_123444444444" |
| baseInfo.metaHandle   | String | 是       | -        | 要创建的元数据标识 | 88.608.6688/META_1666           |
| baseInfo.metaCode     | String | 是       |          | 元数据编码         | META_CODE                       |
| baseInfo.classifyCode | String | 是       |          | 本企业分类         | SP                              |
