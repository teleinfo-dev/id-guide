...
| accessList.handleUsers       | array\[string] | 否        | -        | 要授权的标识用户             | \["88.608.6688/User\_dong"] |
| accessList.removeHandleUsers | array\[string] | 否        | -        | 要移除授权的标识用户           | \["88.608.6688/User\_dzh"]  |
...
| handleUserReaders    | array\[string] | 否        | -        | 授权的查看标识用户              | \["88.608.6688/User\_dong"] |
