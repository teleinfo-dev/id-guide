...
`step4`：企业节点提供标识数据服务，上层应用基于[ID-SDK](../../../dev-tools/commercial/sdk/introduction.md)/[API](../../../dev-tools/commercial/api/introduce.md)获取所需的数据，进行数据、计算、展示、操作、分析等，完成标识应用开发
